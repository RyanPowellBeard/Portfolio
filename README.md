...
A modern, cross-platform desktop application built with **Qt 6** and **C++** designed for managing client invoicing, records, database connections, and business accounting workflows.

--- 

## 📸 Overview 

The OSI Invoicing App provides a clean graphical interface (GUI) and robust database connectivity to manage invoicing pipelines efficiently. Built on CMake and leveraging modern Qt Widgets / Core frameworks, it supports macOS, Linux, and Windows seamlessly.
...
* **Database Integration:** Managed via custom `DatabaseManager` interfaces for secure and performant data storage. 
...
### Using Qt Creator (Recommended) 
 ...
 3. Choose your configured Qt 6 Kit. 
 4. Click **Build** (`Ctrl + B`) or **Run** (`Ctrl + R`).
